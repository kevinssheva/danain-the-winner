  ...
  return (
    <div className="bg-background min-h-screen overflow-hidden">
      <div className="bg-[url('/registercompany/kotakkanan.svg')] bg-right-top bg-no-repeat min-h-screen">
        <div className="bg-[url('/registercompany/kotakkiri.svg')] bg-no-repeat bg-left-bottom min-h-screen">
          <div className="bg-[url('/registerinvestor/glowkanan.svg')] bg-no-repeat bg-left-top min-h-screen">
