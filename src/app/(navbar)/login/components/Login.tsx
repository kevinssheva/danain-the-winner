...
export default function Login() {
  ...
  return (
    <div className="py-12 lg:py-20 px-8 lg:px-24 flex flex-col lg:flex-row-reverse justify-center lg:justify-between">
      <Image src="/login/gambar.svg" width={689} height={500} alt="Danain" className="w-[60%] md:w-1/3 self-center animate-inverseFloat" />
