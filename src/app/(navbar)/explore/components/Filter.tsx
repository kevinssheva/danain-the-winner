...
const Filter = ({
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center w-full gap-5">
      <div className="w-full flex-1 flex items-center gap-3 overflow-hidden">
        <div
              ...
              >
                <Image
                  ...
                  className={`h-[40%] aspect-[4/3] ${
                    category.isBig ? "p-[0.1rem] md:p-[0.3rem]" : "md:p-[0.1rem]"
                  }`}
                />
      ...
      <div
        className="px-4 bg-white rounded-md w-full md:w-auto py-3 flex items-center justify-between gap-3 cursor-pointer"
        onClick={toogleShow}
      >
